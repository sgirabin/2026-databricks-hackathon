...
<div class="side-title">My area</div><div class="subtitle">Preset area state. Editable inputs come after the UI shell is stable.</div>
<div class="area-label">Selected area</div><div class="field location-field">{safe_location}<br>({safe_coords})</div>
<div class="area-label">Discovery radius</div><div class="field">Within {safe_radius_label}</div>
<div class="area-label">Interests</div><div class="tag-wrap">{render_tags(interests)}</div>
<div class="area-label">Try location presets</div>
<div class="preset-grid">
  <a class="preset" href="{make_url(location='Seng Kang, Singapore', coords='1.3871, 103.8915', radius='1500', interests='cheap food,grocery,event,deal')}" target="_self">Sengkang</a>
  <a class="preset" href="{make_url(location='Chinatown MRT, Singapore', coords='1.2844, 103.8435', radius='1000', interests='food,event,shopping')}" target="_self">Chinatown</a>
  <a class="preset" href="{make_url(location='Punggol, Singapore', coords='1.4052, 103.9023', radius='1500', interests='kids,event,grocery')}" target="_self">Punggol</a>
  <a class="preset" href="{make_url(location='Orchard, Singapore', coords='1.3048, 103.8318', radius='1000', interests='shopping,food,deal')}" target="_self">Orchard</a>
</div>
<div class="field save">💾 Area saved in URL</div>
...
<div class="chatbox"><div>🤖 <span class="bubble">Hi, I’m Ask GoAround. Ask me what to eat, what to do with kids, rainy-day options, nearby deals, or a short visitor plan.</span></div><div class="user"><span class="bubble">Any cheap food spots near me?</span> 👤</div><div>🤖 <span class="bubble">Here are some budget-friendly options near {safe_location} within {safe_radius_label}.</span></div></div>
...
''', unsafe_allow_html=True)
        with picks_col:
            st.markdown(f'''
<div class="app-card picks-card"><div class="main-shell-title"><div><h2>Today’s Picks</h2><div class="muted">Curated for {safe_location} based on your area and interests.</div></div><div class="view-all">View all</div></div>
<div class="picklist"><div class="pick"><b>🤖 {safe_first_interest.title()} near {safe_location}</b><br><span class="muted">Local source · within {safe_radius_label}</span><br>Placeholder pick will later come from source-backed data.<br><span class="visit">Visit Website</span></div><div class="pick"><b>🎉 What’s happening around {safe_location}</b><br><span class="muted">Events · within {safe_radius_label}</span><br>Local activities and useful updates near your selected area.<br><span class="visit">Visit Website</span></div><div class="pick"><b>🏷️ Grocery and deal updates</b><br><span class="muted">Interests · {escape(', '.join(interests[:3]))}</span><br>Weekly grocery offers and deal sources near your area.<br><span class="visit">Visit Website</span></div></div><div class="footer" style="color:#175CD3!important;font-weight:800">More picks⌄</div></div>
''', unsafe_allow_html=True)
    elif page == "business":
...
<div class="about-section"><h2>For residents and visitors</h2><p>Ask what to eat, what to do with kids, rainy-day options, nearby deals, or useful updates around your selected area.</p></div><div class="about-section"><h2>For businesses</h2><p>Businesses can create local promotion cards that are shown to nearby users based on location, category, interests, and timing.</p></div><div class="about-section"><h2>Why it is different</h2><p>GoAround SG combines open data, source registries, location, weather, ranking, and AI conversation into one daily local assistant.</p></div><div class="about-section"><h2>Databricks usage in this prototype</h2><ul><li>Databricks Apps hosts the application.</li><li>Lakehouse / Delta can store Bronze, Silver, and Gold local discovery data.</li><li>Databricks SQL warehouse can serve candidate cards when configured.</li><li>Model Serving / GenAI can power Ask GoAround when a serving endpoint is configured.</li></ul></div><div class="footer">GoAround SG — Team R4131N. Source-backed local discovery. Verify final details at source.</div></div>
''', unsafe_allow_html=True)
