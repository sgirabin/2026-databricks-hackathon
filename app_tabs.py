...
st.markdown("""
<style>
.main .block-container {padding-top:.7rem; max-width:1500px; padding-bottom:.5rem;}
section[data-testid="stSidebar"] .block-container {padding-top:.45rem;}
.brand-card {border:1px solid #e2e8f0;border-radius:18px;padding:14px;background:linear-gradient(135deg,#f8fafc,#eef6ff);margin-bottom:18px;}
...
.status-card {border:1px solid #e5e7eb;border-radius:18px;padding:12px 16px;background:white;margin-bottom:10px;box-shadow:0 4px 12px rgba(15,23,42,.04);}
